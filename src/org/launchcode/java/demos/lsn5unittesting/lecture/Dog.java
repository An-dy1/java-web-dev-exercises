...
public class Dog {
  ...
  // CONSTRUCTOR
  public Dog(String name, String ownerName, String size) {
    this.name = name;
    this.ownerName = ownerName;
    // would need to handle setting size like we did previously, compare to allowed sizes
    this.size = size;
  ...
  // overload constructor to set size to null if not given at first
