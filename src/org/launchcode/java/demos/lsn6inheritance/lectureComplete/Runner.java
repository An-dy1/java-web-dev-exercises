...
import org.launchcode.java.demos.lsn6inheritance.lectureComplete.communication.CustomerInteractions2;
...
public class Runner {
  ...
  public static void main(String[] args) {
     ...
     */
    InstallationProject secondProject = new InfinityPoolProject(10, 11, 12, today);
    secondProject.generateQuote();
    ((InfinityPoolProject) secondProject).setAboveGround();
