...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Rainbow sprinkles", 0.50, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Maraschino cherries", 0.99, new ArrayList<>(Arrays.asList("red #5", "cherry")));
        Topping topping3 = new Topping("Dark chocolate flakes", 1.25, new ArrayList<>(Arrays.asList("dairy", "chocolatee")));
        Topping topping4 = new Topping("Whipped cream", 0.65, new ArrayList<>(Arrays.asList("dairy")));
